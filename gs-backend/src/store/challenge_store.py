...
class ChallengeStore(Table):
    ...
    def validate_flags(self, _key: str, flags: Any) -> Any:
        ...
        for flag in flags:
            ...
            assert flag['type'] in ['static', 'leet', 'partitioned', 'multiple'], 'unknown flag type'
            ...
            if flag['type'] in ('partitioned', 'multiple'):
    ...
    FLAG_SNIPPETS = {
        ...
        'multiple': '''{"name": "", "type": "multiple", "val" : ["flag{}"], "base_score": 100}'''
    }
