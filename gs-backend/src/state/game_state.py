...
class Game(WithGameLifecycle):
    def __init__(self,
        ...
        self.boards: Dict[str, Board] = {
            'score_pku': ScoreBoard('排名', None, self, UserStore.MAIN_BOARD_GROUPS, False),
            'first_pku': FirstBloodBoard('一血榜', None, self, UserStore.MAIN_BOARD_GROUPS, False),
            'score_all': ScoreBoard('总排名', '大伙冲冲冲!', self, UserStore.TOT_BOARD_GROUPS, True),
