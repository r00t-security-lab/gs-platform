...
export const GAME_LOGO = <img src="r00tCTF{W51C0me_t0_R00T!!}.jpg" alt="" className="game-logo" />;
...
export const CONTEST_LICENSE = (<>
    <p>
        比赛完全结束后，资料存档将 <ExtLink href="https://github.com/r00t-security-lab/rtctf2023">公开到 GitHub</ExtLink>。
